...
#  Programa principal
################################################################
FRECUENCIAS = lee_serie('C:/Drive/Programacion/Python/PythonSeptiembre/Normalidad/data/frecuencias.csv')
print("Frecuencias[:10] ->", FRECUENCIAS[:10])
PESOS = lee_serie('C:/Drive/Programacion/Python/PythonSeptiembre/Normalidad/data/pesos.csv', float)
print("Pesos[:10] ->", PESOS[:10])
SINTETICA = lee_serie('C:/Drive/Programacion/Python/PythonSeptiembre/Normalidad/data/1000-puntos-normal-0-1.csv', float)
