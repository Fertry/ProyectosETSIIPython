...
def lee_poblaciones(fichero):
    ...
    tuplas = [(nombre,codigo,int(año),float(censo)) for nombre,codigo,año,censo in datos]
...
def calcula_paises(poblaciones):
    ...
    '''
    lista = {nombre for nombre,_,_,_ in poblaciones}
...
def filtra_por_pais(poblaciones, pais):
    ...
    '''
    tuplas = [(año,censo) for nombre,codigo,año,censo in poblaciones if nombre == pais or codigo == pais]
...
def filtra_por_paises_y_anyo(poblaciones, anyo, paises):
    ...
    '''
    tuplas = [(nombre,censo) for nombre,_,año,censo in poblaciones if año == anyo and nombre in paises]
...
def muestra_evolucion_poblacion(poblaciones, pais):
    ...
    una lista de años y otra lista con los número de habitantes (con el mismo orden):
        ...
        plt.show()
    '''
    titulo = "Evolucion de la poblacion de " + pais

    l_anyos = [año for nombre,codigo,año,_ in poblaciones if nombre == pais or codigo == pais]
    l_habitantes = [censo for nombre,codigo,_,censo in poblaciones if nombre == pais or codigo == pais]
...
def muestra_comparativa_paises_anyo(poblaciones, anyo, paises):
    ...
    número de habitantes de esos países:
        ...
        plt.show()
    '''
    titulo = "Poblacion en el año " + str(anyo)

    l_paises = paises
    l_habitantes = [censo for nombre,codigo,año,censo in poblaciones if año == anyo and (nombre in paises or codigo in paises)]
