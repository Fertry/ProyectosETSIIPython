...
#  Programa principal
################################################################
train = lee_dataset_iris('C:/Drive/Programacion/Python/PythonSeptiembre/Vecinos/data/iris_train.csv')
print("ATRIBUTOS TRAIN: ", train[0])
print("CLASES TRAIN: ", train[1])

test = lee_dataset_iris('C:/Drive/Programacion/Python/PythonSeptiembre/Vecinos/data/iris_test.csv')
